...
#finding noun word
 #for i in range(0,len(tag)):
  elif q_noun in tag[i][1]:
     #print(tag[i][0],'......',tag[i][1])
     question_feature.append(tag[i][0])
     s=int(i)
     #break
    
#finding pronoun word    
 #for i in range(0,len(tag)):
  elif q_pronoun in tag[i][1]:
     #print(tag[i][0],'......',tag[i][1])
     question_feature.append(tag[i][0])
     s=int(i)
     break
   ...
   #answer for the object question
        if  'Obj' in question_object:
         ...
         for k in range(object_position-1,0,-1):
            if subj_for_obj==subj_in[k] and copy_sent_lambda_parsing_object[k]=='1':
        ...
        #answer for the subject question
         for l in range(subject_position,0,-1):
            if subj_for_obj==subj_in[l] and copy_sent_lambda_parsing_object[l]=='1':
